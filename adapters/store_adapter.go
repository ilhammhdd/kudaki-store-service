...
func AddStorefrontItem(itemClient kudakiredisearch.RedisClient, partition int32, offset int64, key string, value []byte, dbo usecases.DBOperation) (string, []byte, error) {
	...
	if unmarshalErr == nil {
		...
		storefrontItemAdded := usecases.AddStorefrontItem(itemClient, &asir, dbo)
...
func DeleteStorefrontItem(itemClient kudakiredisearch.RedisClient, partition int32, offset int64, key string, value []byte, dbo usecases.DBOperation) (string, []byte, error) {
